...
<div class="space-y-6 sm:space-y-8">
    <div class="text-center">
        ...
        <p class="text-gray-300 text-base sm:text-lg px-2">
            Explore advanced state management features: deep reactivity,
            snapshots, raw state, and untracking.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
        ...
        >
            <h3
                class="text-xl sm:text-2xl font-semibold text-blue-300 mb-3 sm:mb-4"
            >
                💎 Basic State
            </h3>
            <div class="space-y-3 sm:space-y-4">
                <div class="bg-black/30 rounded-lg p-3 sm:p-4">
                    <p class="block text-white mb-2 text-sm sm:text-base">
                        Counter: {counter}
                    </p>
                    <button
                        class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 sm:px-4 rounded-lg transition-colors text-sm sm:text-base"
                ...
                <div class="bg-black/30 rounded-lg p-4">
                    <label for="state-name" class="block text-white mb-2"
                        >Name:</label
                    >
                    <input
                        id="state-name"
            ...
            <div class="space-y-4">
                <div class="bg-black/30 rounded-lg p-4">
                    ...
                    <p class="text-gray-300">
                        Theme: {profile.user.preferences.theme}
                    </p>
                    <button
                ...
                <div class="bg-black/30 rounded-lg p-4">
                    ...
                    <div class="space-y-2 max-h-32 overflow-y-auto">
                        {#each profile.posts as post}
                            <div
                                class="flex justify-between items-center bg-black/40 rounded p-2"
                            >
    ...
    <!-- Derived State -->
    <div class="bg-white/10 rounded-2xl p-6 border border-white/20">
        <h3 class="text-2xl font-semibold text-green-300 mb-4">
            ⚡ Derived State
        </h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white/10 rounded-2xl p-6 border border-white/20">
            <h3 class="text-2xl font-semibold text-orange-300 mb-4">
                🔒 $state.raw
            </h3>
        ...
        <div class="bg-white/10 rounded-2xl p-6 border border-white/20">
            <h3 class="text-2xl font-semibold text-pink-300 mb-4">
                📸 State Snapshots
            </h3>
            <p class="text-gray-400 mb-4">
                Capture static snapshots of reactive state for history/undo
                functionality.
            </p>
            ...
            <div class="space-y-3">
                ...
                <div
                    class="bg-black/30 rounded-lg p-4 max-h-32 overflow-y-auto"
                >
                    <p class="text-white mb-2">
                    ...
                    {#each history as snapshot}
                        <div
                            class="text-gray-300 text-xs border-b border-gray-700 pb-1 mb-1"
                        >
                            {snapshot.timestamp}: {(
                                snapshot.data as typeof profile
                            ).posts.length} posts, {(
                                snapshot.data as typeof profile
                            ).user.name}
                        </div>
    ...
    <!-- Untrack Demo -->
    <div class="bg-white/10 rounded-2xl p-6 border border-white/20">
        <h3 class="text-2xl font-semibold text-red-300 mb-4">
            🚫 Untrack Function
        </h3>
        <p class="text-gray-400 mb-4">
        ...
        <div class="bg-black/30 rounded-lg p-4">
            ...
            <p class="text-gray-400 text-sm mt-2">
                Check console for untracked access log
            </p>
        </div>
    </div>
    ...
    <div class="bg-black/40 rounded-2xl p-6 border border-white/20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
                ...
                <pre
                    class="bg-black/60 rounded-lg p-4 text-sm text-gray-300 overflow-x-auto"><code
                        >let profile = $state({`{
  user: {
    name: 'Alice',
